...
const emojiStarImage = '/emojistar.svg';
const helixImage = '/helix2.svg';
...
export function CallToAction() {
  ...
  return (
    <div
      className=" bg-gradient-to-b from-[#0a0f1d] to-[#231814] py-[72px] text-center text-white px-[400px] sm:py-24"
      ref={containerRef}
    >
